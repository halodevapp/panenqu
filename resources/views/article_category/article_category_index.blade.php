<?php $page_title = 'Master Article Category'; ?>
                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form
                                            action="{{ route('article-category.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table-article-categories" class="table table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                            ...
                                            @foreach ($articleCategories as $category)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ route('article-category.edit', ['article_category' => $category->id]) }}"
                                                            class="btn btn-xs btn-success" title="Edit">
                                                            <i class="far fa-edit fa-fw"></i>
                                                        </a>
                                                        <form
                                                            action="{{ route('article-category.destroy', ['article_category' => $category->id]) }}"
                                                            method="POST" class="d-inline">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
                                                                class="delete_article_category btn btn-xs btn-danger"
                                                                title="Delete">
                                ...
                                <div class="mt-2 float-right">
                                    {{ $articleCategories->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('page-js')
    <script>
        $(function() {
            ...
            $('.delete_article_category').click(function(e) {
                var dis = this;
                e.preventDefault();
                Swal.fire({
