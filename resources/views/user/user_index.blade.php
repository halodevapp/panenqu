                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form action="{{ route('user.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table-users" class="table table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        ...
                                                        <form action="{{ route('user.destroy', ['user' => $user->id]) }}"
                                                            ...
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit" class="delete_user btn btn-xs btn-danger"
                                                                title="Delete">
                                ...
                                <div class="mt-2 float-right">
                                    {{ $users->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
