    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="article_form" action="{{ route('article.store') }}" class="form-horizontal" method="POST"
                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                                            ...
                                                            <select id="article_category" name="article_category"
                                                                ...
                                                                @foreach ($categories as $category)
                                                                    <option value="{{ $category->id }}"
                                                                        {{ old('article_category') == $category->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control @error('article_content') is-invalid @enderror" id="article_content"
                                                                name="article_content" placeholder="Article Description" rows="5">{{ old('article_content') }}</textarea>
                                ...
                                <div class="card-footer">
                                    ...
                                    <button id="publish" type="button" class="ml-1 btn btn-primary float-right">Save
                                        and Publish</button>
                                    <button id="draft" type="button"
                                        class="btn btn-success float-right">Draft</button>
                                </div>
                            </div>
                        </form>
                    </div>
