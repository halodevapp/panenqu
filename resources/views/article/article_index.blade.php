                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form action="{{ route('article.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table-articles" class="table table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        ...
                                                        <form
                                                            ...
                                                            @method('delete')
                                                            <button type="submit"
                                                                class="delete_article btn btn-xs btn-danger" title="Delete">
                                ...
                                <div class="mt-2 float-right">
                                    {{ $articles->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
