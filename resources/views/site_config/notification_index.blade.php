                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    <div class="col-lg-6 my-1">
                                        <a href="{{ route('config.notification.create') }}"
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form
                                            action="{{ route('config.notification.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table-notifications" class="table table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                            ...
                                            @foreach ($notifications as $notification)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ route('config.notification.edit', ['id' => $notification->id]) }}"
                                                            class="btn btn-xs btn-success" title="Edit">
                                                            <i class="far fa-edit fa-fw"></i>
                                                        </a>
                                                        <form
                                                            action="{{ route('config.notification.destroy', ['id' => $notification->id]) }}"
                                                            method="POST" class="d-inline">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
                                                                class="delete_notification btn btn-xs btn-danger"
                                                                title="Delete">
                                                    ...
                                                    <td>{{ $notification->updatedBy->name }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <div class="mt-2 float-right">
                                    {{ $notifications->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
