<?php $page_title = 'Master Customer'; ?>
                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form action="{{ route('customer.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        ...
                                                        <form
                                                            ...
                                                            @method('delete')
                                                            <button type="submit"
                                                                class="delete_customer btn btn-xs btn-danger"
                                                                title="Delete">
                                ...
                                <div class="mt-2 float-right">
                                    {{ $customers->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
