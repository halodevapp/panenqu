        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="{{ route('store.store') }}" class="form-horizontal" method="POST"
                                                    ...
                                                    <select id="store_type_id" name="store_type_id"
                                                        ...
                                                        @foreach ($storeTypes as $storeType)
                                                            <option value="{{ $storeType->id }}"
                                                                {{ old('store_type_id') == $storeType->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control @error('store_location') is-invalid @enderror" id="store_location" name="store_location"
                                                        placeholder="Store Location" rows="5">{{ old('store_location') }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="d-none" type="text" id="latitude" name="latitude"
                                                        value="{{ old('latitude', -6.2275685098177975) }}">
                                                    <input class="d-none" type="text" id="longitude" name="longitude"
                                                        value="{{ old('latitude', 106.80613175435577) }}">
