<?php $page_title = 'Master Customer Category'; ?>
                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    <div class="col-lg-6 my-1">
                                        <a href="{{ route('customer-category.create') }}"
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form
                                            action="{{ route('customer-category.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table-customer-categories" class="table table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                            ...
                                            @foreach ($customerCategories as $category)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ route('customer-category.edit', ['customer_category' => $category->id]) }}"
                                                            class="btn btn-xs btn-success" title="Edit">
                                                            <i class="far fa-edit fa-fw"></i>
                                                        </a>
                                                        <form
                                                            action="{{ route('customer-category.destroy', ['customer_category' => $category->id]) }}"
                                                            method="POST" class="d-inline">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
                                                                class="delete_customer_category btn btn-xs btn-danger"
                                                                title="Delete">
                                ...
                                <div class="mt-2 float-right">
                                    {{ $customerCategories->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('page-js')
    <script>
        $(function() {
            ...
            $('.delete_customer_category').click(function(e) {
                var dis = this;
                e.preventDefault();
                Swal.fire({
