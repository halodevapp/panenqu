<?php $page_title = 'Create Product Category'; ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="product_category_form" action="{{ route('product-category.store') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control @error('category_description') is-invalid @enderror" id="category_description"
                                                                name="category_description" placeholder="Category Description" rows="5">{{ old('category_description') }}</textarea>
