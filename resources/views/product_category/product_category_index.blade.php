<?php $page_title = 'Master Product Category'; ?>
                        ...
                        <div class="card">
                            <div class="card-header py-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 offset-lg-2 my-1">
                                        <form
                                            action="{{ route('product-category.index', ['search' => request()->get('search')]) }}"
                                            method="GET">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table-product-categories" class="table table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                            ...
                                            @foreach ($productCategories as $productCategory)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ route('product-category.edit', ['product_category' => $productCategory->id]) }}"
                                                        ...
                                                        <form
                                                            ...
                                                            @method('delete')
                                                            <button type="submit"
                                                                class="delete_product_category btn btn-xs btn-danger"
                                                                title="Delete">
                                ...
                                <div class="mt-2 float-right">
                                    {{ $productCategories->onEachSide(2)->appends(['search' => request()->get('search')])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
