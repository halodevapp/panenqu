        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="{{ route('testimoni.update', ['testimoni' => $testimoni->id]) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('profession', $testimoni->profession) }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control @error('testimoni') is-invalid @enderror" id="testimoni" name="testimoni"
                                                        placeholder="Testimoni" rows="5">{{ old('testimoni', $testimoni->testimoni) }}</textarea>
