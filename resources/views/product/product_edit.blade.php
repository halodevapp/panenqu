...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="col-lg-12">
                    <form id="product_form" action="{{ route('product.update', ['product' => $product->id]) }}"
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0 border-bottom-0">
                                <ul class="nav nav-tabs nav-fill" id="product-tab-header" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="product-media-tab" data-toggle="pill" href="#product-media"
                                            role="tab" aria-controls="product-media" aria-selected="false">Media</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content" id="product-tab-header">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text"
                                                            ...
                                                            id="sequence" name="sequence" placeholder="Product Sequence"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control @error('product_description') is-invalid @enderror" id="product_description"
                                                            name="product_description" placeholder="Product Description" rows="5">{{ old('product_description', $product->product_description) }}</textarea>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old("marketplace_link.$store->id", $store->product->product_store_link) }}">
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="product_image">Choose
                                                                file</label>
                                                            <span id="product_image_error" class="error invalid-feedback">
                                                                @error('product_image')
                                                                    {{ $message }}
                                                                @enderror
                                                            </span>
                                                ...
                                                <div class="col mb-4">
                                                    <div class="card h-100">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <a data-id="{{ $image->id }}"
                                                                class="remove_existing btn btn-xs btn-danger"
                                                                title="Delete">
                                                                Remove
                                                            </a>
                                                        </div>
...
@section('page-js')
    ...
    <script>
        ...
        $(function() {
            ...
            $('.remove_existing').click(function(e) {
