...
class ProductCategoryPolicy
{
    ...
    {
        return $user->can('PRODUCT_CATEGORY_VIEW');
    }
    ...
    {
        return $user->can('PRODUCT_CATEGORY_CREATE');
    }
    ...
    {
        return $user->can('PRODUCT_CATEGORY_UPDATE');
    }
    ...
    {
        return $user->can('PRODUCT_CATEGORY_DELETE');
    }
